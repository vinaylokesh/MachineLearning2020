...
from sklearn.model_selection import LeaveOneOut#from sklearn.grid_search import GridSearchCV
...
def addFeatures(dataframe, adjclose, returns, n):
    ...
    dataframe[roll_n] =  dataframe[returns].rolling(n).mean() # pd.rolling_mean(dataframe[returns], n)
